...
Encryption is enabled when VAULT_ENCRYPTION_KEY environment variable
...
from vault_core.database.repository import ensure_record_id, repo_query, repo_upsert
from vault_core.domain.base import RecordModel
from vault_core.utils.encryption import decrypt_value, encrypt_value
...
class ProviderConfig(RecordModel):
    ...
    record_id: ClassVar[str] = "vault_core:provider_configs"
    ...
    def _prepare_save_data(self) -> dict:
        ...
        VAULT_ENCRYPTION_KEY is configured.
        """
        data = {"credentials": {}}
    ...
    async def save(self) -> "ProviderConfig":
        ...
        await repo_upsert("vault_core", self.record_id, data)
        return self
