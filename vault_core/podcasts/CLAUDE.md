...
- `vault_core.domain.base`: ObjectModel base class
- `vault_core.ai.models`: Model class (for `_resolve_model_config`)
- `vault_core.ai.key_provider`: provision_provider_keys (fallback)
- `vault_core.domain.credential`: Credential (for migration)
