...
A flexible and generic ContextBuilder class for the Vault project that can handle any parameters and build context from sources, notebooks, insights, and notes.
...
```python
from vault_core.utils.context_builder import (
...
```python
from vault_core.utils.context_builder import ContextConfig
...
```python
from vault_core.utils.context_builder import ContextItem
...
The ContextBuilder integrates seamlessly with the existing Vault architecture:
