...
class AsyncMigrationManager:
    ...
    def __init__(self):
        ...
        self.up_migrations = [
            AsyncMigration.from_file("vault_core/database/migrations/1.surrealql"),
            AsyncMigration.from_file("vault_core/database/migrations/2.surrealql"),
            AsyncMigration.from_file("vault_core/database/migrations/3.surrealql"),
            AsyncMigration.from_file("vault_core/database/migrations/4.surrealql"),
            AsyncMigration.from_file("vault_core/database/migrations/5.surrealql"),
            AsyncMigration.from_file("vault_core/database/migrations/6.surrealql"),
            AsyncMigration.from_file("vault_core/database/migrations/7.surrealql"),
            AsyncMigration.from_file("vault_core/database/migrations/8.surrealql"),
            AsyncMigration.from_file("vault_core/database/migrations/9.surrealql"),
            AsyncMigration.from_file("vault_core/database/migrations/10.surrealql"),
            AsyncMigration.from_file(
                "vault_core/database/migrations/11.surrealql"
            ),
            AsyncMigration.from_file(
                "vault_core/database/migrations/12.surrealql"
            ),
            AsyncMigration.from_file(
                "vault_core/database/migrations/13.surrealql"
            ),
            AsyncMigration.from_file(
                "vault_core/database/migrations/14.surrealql"
            ),
            AsyncMigration.from_file(
                "vault_core/database/migrations/15.surrealql"
            ),
            AsyncMigration.from_file(
                "vault_core/database/migrations/16.surrealql"
            ),
            AsyncMigration.from_file(
                "vault_core/database/migrations/17.surrealql"
            ),
            AsyncMigration.from_file(
                "vault_core/database/migrations/18.surrealql"
            ),
            AsyncMigration.from_file(
                "vault_core/database/migrations/19.surrealql"
            ),
            AsyncMigration.from_file(
        ...
        self.down_migrations = [
            AsyncMigration.from_file(
                "vault_core/database/migrations/1_down.surrealql"
            ),
            AsyncMigration.from_file(
                "vault_core/database/migrations/2_down.surrealql"
            ),
            AsyncMigration.from_file(
                "vault_core/database/migrations/3_down.surrealql"
            ),
            AsyncMigration.from_file(
                "vault_core/database/migrations/4_down.surrealql"
            ),
            AsyncMigration.from_file(
                "vault_core/database/migrations/5_down.surrealql"
            ),
            AsyncMigration.from_file(
                "vault_core/database/migrations/6_down.surrealql"
            ),
            AsyncMigration.from_file(
                "vault_core/database/migrations/7_down.surrealql"
            ),
            AsyncMigration.from_file(
                "vault_core/database/migrations/8_down.surrealql"
            ),
            AsyncMigration.from_file(
                "vault_core/database/migrations/9_down.surrealql"
            ),
            AsyncMigration.from_file(
                "vault_core/database/migrations/10_down.surrealql"
            ),
            AsyncMigration.from_file(
                "vault_core/database/migrations/11_down.surrealql"
            ),
            AsyncMigration.from_file(
                "vault_core/database/migrations/12_down.surrealql"
            ),
            AsyncMigration.from_file(
                "vault_core/database/migrations/13_down.surrealql"
            ),
            AsyncMigration.from_file(
                "vault_core/database/migrations/14_down.surrealql"
            ),
            AsyncMigration.from_file(
                "vault_core/database/migrations/15_down.surrealql"
            ),
            AsyncMigration.from_file(
                "vault_core/database/migrations/16_down.surrealql"
            ),
            AsyncMigration.from_file(
                "vault_core/database/migrations/17_down.surrealql"
            ),
            AsyncMigration.from_file(
                "vault_core/database/migrations/18_down.surrealql"
            ),
            AsyncMigration.from_file(
                "vault_core/database/migrations/19_down.surrealql"
            ),
            AsyncMigration.from_file(
