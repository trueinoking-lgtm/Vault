export const enUS = {
  ...
  notebooks: {
    ...
    noNotesYet: "No leaves yet",
    deleteNote: "Delete Leaf",
    deleteNoteConfirm: "Are you sure you want to delete this leaf? This action cannot be undone.",
  ...
  sources: {
    ...
    createFirstNote: "Create your first leaf to capture insights and observations.",
    urlLabel: "URL(s) *",
    fileLabel: "File(s) *",
