export const enUS = {
  common: {
    ...
    note: "Note",
    insight: "Insight",
    newSource: "New Material",
    newNotebook: "New Library",
    language: "Language",
    english: "English",
    chinese: "简体中文",
    japanese: "日本語",
    ...
    accessibility: {
      ...
      searchNotebooks: "Search libraries",
    },
    url: "URL",
  ...
  apiErrors: {
    notebookNotFound: "Library not found",
    sourceNotFound: "Material not found",
    ...
    invalidSourceType: "Invalid material type",
  ...
  connectionErrors: {
    ...
    apiDesc: "The Vault API server could not be reached",
  ...
  notebooks: {
    ...
    deleteNotebookExclusiveSources: "{count} material(s) exist only in this library.",
    deleteNotebookSharedSources: "{count} material(s) are shared with other libraries and will be unlinked.",
    deleteNotebookNoSources: "No materials in this library.",
    deleteExclusiveSourcesLabel: "Delete exclusive materials",
    keepExclusiveSourcesLabel: "Unlink and keep them",
    activeNotebooks: "Active Libraries",
    archivedNotebooks: "Archived Libraries",
    tileView: "Tile view",
    listView: "List view",
    notFound: "Library not found",
    notFoundDesc: "The requested library does not exist.",
    updated: "Updated",
    namePlaceholder: "Library name",
    addDescription: "Add description...",
    deleteNote: "Delete Leaf",
    noteCreatedSuccess: "Leaf created successfully",
    failedToCreateNote: "Failed to create leaf",
    noteUpdatedSuccess: "Leaf updated successfully",
    failedToUpdateNote: "Failed to update leaf",
    noteDeletedSuccess: "Leaf deleted successfully",
    failedToDeleteNote: "Failed to delete leaf",
    createNew: "Create New Library",
    createNewDesc: "Enter a name and optional description to get started.",
    descPlaceholder: "Add more info about this library here...",
  ...
  sources: {
    ...
    addExisting: "Add existing material",
    delete: "Delete Material",
    statusProcessing: "Processing",
    failedToLoad: "Failed to load materials",
    allSourcesDesc: "View all your materials here. You can add new materials or manage existing ones.",
    allSources: "All Materials",
    insights: "Insights",
    yes: "Yes",
    no: "No",
    loadingMore: "Loading more...",
    noSourcesYet: "No materials yet",
    cannotSaveNoteNoNotebook: "Cannot save note: library ID not available",
    createFirstSource: "Add your first material to start building your knowledge base.",
    deleteSourceConfirm: "Are you sure you want to delete this material?",
    deleteConfirm: "Are you sure you want to delete this?",
    deleteConfirmWithTitle: "Are you sure you want to delete \"{title}\"?",
    deleteSuccess: "Material deleted successfully. Note: To delete the file from storage, you must enable checking the \"delete file\" option in the settings page.",
    failedToDelete: "Failed to delete material",
    sourceQueued: "Material Queued",
    sourceQueuedDesc: "Material submitted for background processing. You can monitor progress in the materials list.",
    sourceAddedSuccess: "Material added successfully",
    failedToAddSource: "Failed to add material",
    sourceUpdatedSuccess: "Material updated successfully",
    failedToUpdateSource: "Failed to update material",
    sourceDeletedSuccess: "Material deleted successfully",
    failedToDeleteSource: "Failed to delete material",
    fileUploadedSuccess: "File uploaded successfully",
    failedToUploadFile: "Failed to upload file",
    sourceRequeued: "Material Retry Queued",
    sourceRequeuedDesc: "The material has been requeued for processing.",
    failedToRetry: "Retry Failed",
    sourcesAddedToNotebook: "{count} material(s) added to library",
    failedToAddSourcesToNotebook: "Failed to add materials to library",
    partialAddSuccess: "{success} material(s) added, {failed} failed",
    sourceRemovedFromNotebook: "Material removed from library successfully",
    failedToRemoveSourceFromNotebook: "Failed to remove material from library",
    removeConfirm: "Are you sure you want to remove this from the library?",
    checking: "Checking...",
    untitledSource: "Untitled Material",
    maxItems: "max {count}",
    ...
    leaves: "Leaves",
    noLeavesYet: "No leaves yet",
    createLeaf: "Create leaf",
    createLeafShort: "Create Leaf",
    createLeafBtn: "Create Leaf",
    createFirstLeaf: "Create your first leaf from a material to capture summaries, lessons, and insights.",
    deleteLeaf: "Delete Leaf",
    deleteLeafConfirm: "Are you sure you want to delete this leaf? This action cannot be undone.",
    untitledLeaf: "Untitled Leaf",
    writeLeafPlaceholder: "Write your leaf here using the material as your source...",
    editNote: "Edit leaf",
    createNote: "Create leaf",
    addTitle: "Add a title...",
    untitledNote: "Untitled Leaf",
    writeNotePlaceholder: "Write your leaf content here...",
    saveNote: "Save Leaf",
    createNoteBtn: "Create Leaf",
    urlLabel: "URL(s) *",
    fileLabel: "File(s) *",
    ...
    titlePlaceholder: "Give your material a descriptive title",
    batchTitlesAuto: "Titles will be automatically generated for each material.",
    batchCommonSettings: "The same libraries and transformations will be applied to all items.",
    urlsCount: "{count} URL(s)",
    filesCount: "{count} file(s)",
    addSource: "Add material",
    ...
    viewSource: "View Material",
    noInsightSelected: "No insight selected",
    sourceInsight: "Material Insight",
    manageNotebooks: "Manage Libraries",
    manageNotebooksDesc: "Manage which libraries contain this material",
    noNotebooksAvailable: "No libraries available",
    loadFailed: "Failed to load material details",
    removeFromNotebook: "Remove from Library",
    retryProcessing: "Retry Processing",
    refreshContent: "Refresh content",
    deleteSource: "Delete Material",
    retry: "Retry",
    addExistingTitle: "Add Existing Materials",
    addExistingDesc: "Select existing materials from across all your libraries to add to the current one.",
    searchPlaceholder: "Search materials by name or URL...",
    noNotebooksFound: "No libraries found.",
    showingFirst100: "Showing first 100 materials. Use search to find specific ones.",
    selectedCount: "{count} materials selected",
    added: "Added on {date}",
    addUrl: "Add URL",
    ...
    embeddingDesc: "Allows this material to be found in vector searches and AI queries",
    ...
    embeddingNeverDesc: "Your settings are configured to skip embedding. Vector search won't be available for this material.",
    ...
    batchSuccess: "{count} material(s) created successfully",
    batchFailed: "Failed to create all {count} materials",
    batchPartial: "{success} succeeded, {failed} failed",
    submittingSource: "Submitting material for processing...",
    processingBatchSources: "Processing {count} materials. This may take a few moments.",
    processingSource: "Your material is being processed. This may take a few moments.",
    maxFilesAllowed: "Maximum {count} files allowed per batch",
    studyThisMaterial: "Study this material",
    openMaterial: "Open material",
    askAboutThisMaterial: "Ask About This Material",
    statusPreparingText: "Preparing your material",
    statusPreparingTextDesc: "Your material is being prepared for processing. This usually takes a moment.",
    statusBuildingStudyMemory: "Building study memory",
    statusBuildingStudyMemoryDesc: "We're analyzing your material and building your study memory so you can interact with it.",
    statusReadyToStudy: "Ready to study",
  ...
  chat: {
    ...
    sendPlaceholder: "Ask anything about your materials...",
    ...
    chatWithNotebook: "Chat with Library",
    unableToLoadChat: "Unable to load chat",
    noDescription: "No description",
    startByCreating: "Start by creating your first library to organize your research.",
  ...
  searchPage: {
    ...
    ask: "Ask",
    processing: "Processing...",
    saveToNotebooks: "Save to Libraries",
    ...
    searchIn: "Search In",
    searchSources: "Search Materials",
    searchNotes: "Search Notes",
    resultsFound: "{count} results found",
    matches: "Matches ({count})",
    noResultsFor: "No results found for “{query}”",
    notSet: "Not set",
    saveToNotebook: "Save to Library",
    saveSuccess: "Successfully saved to library",
    saveError: "Failed to save to library",
    selectNotebook: "Select Library",
  ...
  podcasts: {
    ...
    content: "Content",
    contentDesc: "Pick libraries, materials, and notes to include in this episode.",
    itemsSelected: "{count} items selected",
    tokens: "{count} tokens",
    chars: "{count} chars",
    loadingNotebooks: "Loading libraries...",
    noNotebooksFoundInPodcasts: "No libraries found. Create a library and add content before generating a podcast.",
    ...
    addContextDesc: "Select at least one material or note to include in the episode.",
    generationFailed: "Podcast generation failed",
    speakerProfile: "Speaker Profile",
    usesSpeakerProfile: "Uses speaker profile",
    materials: "Materials",
    notes: "Notes",
    noSources: "No materials available in this library.",
    noNotes: "No notes available in this library.",
    ...
    noEpisodesYet: "No podcast episodes yet. Generate your first one from the library or material chat interfaces.",
  ...
  settings: {
    ...
    filesHelp: "Once your files are uploaded and processed, they are not required anymore. Most users should allow Vault to delete uploaded files from the upload folder automatically.",
  ...
  advanced: {
    ...
    rebuildEmbeddingsDesc: "Rebuild vector search index for all materials",
    currentVersion: "Current Version",
    latestVersion: "Latest Version",
    status: "Status",
    updateAvailable: "Version {version} Available",
    updateAvailableDesc: "A new version of Vault is available.",
    upToDate: "Up to Date",
    unknown: "Unknown",
  ...
  transformations: {
    ...
    desc: "Transformations are prompts that will be used by the LLM to process a material and extract insights, summaries, etc.",
    ...
    suggestDefault: "Suggest by default on new materials",
    promptHint: "Prompts should be written with the material content in mind. You can ask the model to summarise, extract insights, or produce structured outputs such as tables.",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configure which models to use for different purposes across Vault",
    missingRequiredModels: "Missing required models: {models}. Vault may not function properly without these.",
  ...
  apiKeys: {
    ...
    description: "Store API keys securely in the database to enable AI providers in Vault.",
    encryptionRequired: "Encryption key not configured",
    encryptionRequiredDescription: "Set the VAULT_ENCRYPTION_KEY environment variable to any secret string to enable storing API keys in the database.",
  ...
  setupBanner: {
    encryptionRequired: "Encryption key not configured",
    encryptionRequiredDescription: "Set the VAULT_ENCRYPTION_KEY environment variable to enable secure credential storage.",
  ...
  vault: {
    ...
    firstLibraryTitle: "Start your first library",
    firstLibraryBody: "Choose a subject or topic. Vault will keep your materials, leaves, and study sessions together.",
    firstLibraryCta: "Create your first library",
    ...
    noLearningMemory: "No Learning Memory yet",
    noLearningMemoryDesc: "Start a study session in any library to build your memory.",
    ...
    recentMaterialsDesc: "Materials you recently added or updated.",
    noRecentMaterials: "No materials yet. Add your first material to get started.",
    recentLeaves: "Recent Leaves",
    recentLeavesDesc: "Leaves you recently created or updated.",
    noRecentLeaves: "No leaves yet. Create your first leaf in a library.",
    ...
    reviewQueueEmptyNew: "Nothing to review yet",
    reviewQueueEmptyNewDesc: "Use Check yourself on a leaf and Vault will start building your review queue.",
    reviewQueueNeedsReview: "Needs review",
    reviewQueueNeedsReviewSingle: "1 leaf needs another look.",
    reviewQueueNeedsReviewMultiple: "{count} leaves need another look.",
    reviewQueueRemembered: "Recently remembered",
    ...
    checklist: {
      title: "Get started",
      allComplete: "All done — you are ready to study!",
      createLibrary: "Create your first library",
      createLibraryCta: "Create library",
      addMaterial: "Add your first material",
      addMaterialCta: "Add material",
      materialReady: "Wait for material to be ready",
      materialReadyCta: "View materials",
      startStudying: "Start studying",
      startStudyingCta: "Open library",
      reviewMissed: "Review what you missed",
      reviewMissedCta: "Review",
    },
  },
  tts: {
    listen: "Listen",
  ...
  schools: {
    title: "Schools",
    description: "Manage the schools connected to this Vault.",
    createSchool: "Create School",
    editSchool: "Edit School",
    createDescription: "Create a new school to group classrooms, teachers, and learners.",
    editDescription: "Update the basic details of this school.",
    name: "Name",
    slug: "Slug",
    descLabel: "Description",
    noSchools: "No schools yet. Create your first school to get started.",
    loadError: "Failed to load schools. Please try again.",
    createSuccess: "School created successfully.",
    updateSuccess: "School updated successfully.",

    // Members
    members: "Members",
    noMembers: "No members yet. Add a teacher or learner to get started.",
    memberLoadError: "Failed to load members. Please try again.",
    createMember: "Add Member",
    editMember: "Edit Member",
    createMemberDescription: "Add a user as a member of this school.",
    editMemberDescription: "Update the member's role or status.",
    memberCreateSuccess: "Member added successfully.",
    ...
    noClassrooms: "No classrooms yet. Create one to group learners.",
    classroomLoadError: "Failed to load classrooms. Please try again.",
    createClassroom: "Create Classroom",
    editClassroom: "Edit Classroom",
    createClassroomDescription: "Create a new classroom within this school.",
    editClassroomDescription: "Update the classroom details.",
    classroomCreateSuccess: "Classroom created successfully.",
    classroomUpdateSuccess: "Classroom updated successfully.",
    classroomName: "Name",
    classroomSubject: "Subject",
    classroomGradeLevel: "Grade Level",
    teacherId: "Teacher Membership ID",
