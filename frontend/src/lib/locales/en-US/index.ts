export const enUS = {
  ...
  vault: {
    ...
    firstMaterialTitle: "Add your first material",
    firstMaterialBody: "Your library is ready. Add a PDF, link, audio, video, or text so Vault can start organizing your study materials.",
    continue: "Continue",
