export const ptBR = {
  ...
  connectionErrors: {
    ...
    apiDesc: "O servidor da API do Vault não pôde ser alcançado",
  ...
  settings: {
    ...
    filesHelp: "Uma vez que seus arquivos são enviados e processados, eles não são mais necessários. A maioria dos usuários deve permitir que o Vault exclua arquivos enviados da pasta de upload automaticamente.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Uma nova versão do Vault está disponível.",
    upToDate: "Atualizado",
    unknown: "Desconhecido",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configure quais modelos usar para diferentes propósitos no Vault",
    missingRequiredModels: "Modelos obrigatórios ausentes: {models}. O Vault pode não funcionar corretamente sem eles.",
  ...
  apiKeys: {
    ...
    description: "Armazene chaves de API com segurança no banco de dados para habilitar provedores de IA no Vault.",
    encryptionRequired: "Chave de criptografia não configurada",
    encryptionRequiredDescription: "Configure a variável de ambiente VAULT_ENCRYPTION_KEY com qualquer string secreta para armazenar chaves de API no banco de dados.",
  ...
  setupBanner: {
    encryptionRequired: "Chave de criptografia não configurada",
    encryptionRequiredDescription: "Configure a variável de ambiente VAULT_ENCRYPTION_KEY para habilitar o armazenamento seguro de credenciais.",
