export const ruRU = {
  ...
  connectionErrors: {
    ...
    apiDesc: "API-сервер Vault недоступен",
  ...
  settings: {
    ...
    filesHelp: "После загрузки и обработки файлы больше не нужны. Большинству пользователей следует разрешить Vault автоматически удалять загруженные файлы из папки загрузок.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Доступна новая версия Vault.",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Настройте, какие модели использовать для различных задач в Vault",
    missingRequiredModels: "Отсутствуют необходимые модели: {models}. Vault может работать некорректно без них.",
  ...
  apiKeys: {
    ...
    description: "Храните API-ключи в базе данных для безопасного подключения провайдеров ИИ в Vault.",
    encryptionRequired: "Ключ шифрования не настроен",
    encryptionRequiredDescription: "Установите переменную окружения VAULT_ENCRYPTION_KEY в любую секретную строку для хранения API-ключей в базе данных.",
  ...
  setupBanner: {
    encryptionRequired: "Ключ шифрования не настроен",
    encryptionRequiredDescription: "Установите переменную окружения VAULT_ENCRYPTION_KEY для безопасного хранения учётных данных.",
