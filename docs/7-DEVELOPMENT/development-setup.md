...
This guide walks you through setting up Vault for local development. Follow these steps to get the full stack running on your machine.
...
VAULT_ENCRYPTION_KEY=my-dev-secret-key
...
uv run pytest --cov=vault_core --cov-report=html
```
