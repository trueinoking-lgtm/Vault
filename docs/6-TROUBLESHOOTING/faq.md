...
Common questions about Vault usage, configuration, and best practices.
...
Vault is an open-source, privacy-focused alternative to Google's Notebook LM. It allows you to:
...
- Use `VAULT_PASSWORD` for public deployments
...
Submit to: [GitHub Issues](https://github.com/lfnovo/vault/issues)
