...
from vault_core.database.repository import ensure_record_id, repo_insert, repo_query
from vault_core.domain.notebook import Note, Source, SourceInsight
from vault_core.exceptions import ConfigurationError
from vault_core.utils.chunking import ContentType, chunk_text, detect_content_type
...
@command("vectorize_source", app="vault_core", retry=None)
...
@command("rebuild_embeddings", app="vault_core", retry=None)
